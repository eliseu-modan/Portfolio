...
setInterval(() => {
    ...
    const nsoft =MudarCornomeSoftware()
        ...
        <div ref={containerRef} className="DescricaoCabeçalho" >
            <h4> <span  id="nomeSoftware"> Engenheiro de Software </span><br/><br /><span id="nomeWeb">Desenvolvedor Front-End</span> <br /><br /><span id="nomeJava"> Desenvolvedor Back-End</span></h4>
